...
iTj(3,1,1) = 0; iTj(3,2,1) = 0; iTj(3,3,1) = 1; iTj(3,4,1) = 0.193;
iTj(4,1,1) = 0; iTj(4,2,1) = 0; iTj(4,3,1) = 0; iTj(4,4,1) = 1;

iTj(1,1,2) = 0; iTj(1,2,2) = 0;  iTj(1,3,2) = -1; iTj(1,4,2) = -0.1805;
iTj(2,1,2) = 0; iTj(2,2,2) = 1;  iTj(2,3,2) = 0; iTj(2,4,2) = 0;
iTj(3,1,2) = 1; iTj(3,2,2) = 0;  iTj(3,3,2) = 0; iTj(3,4,2) = 0;
iTj(4,1,2) = 0; iTj(4,2,2) = 0;  iTj(4,3,2) = 0; iTj(4,4,2) = 1;

iTj(1,1,3) = 0; iTj(1,2,3) = 1; iTj(1,3,3) = 0;  iTj(1,4,3) = 0.615;
...
iTj(1,1,4) = 1; iTj(1,2,4) = 0;  iTj(1,3,4) = 0; iTj(1,4,4) = 0;
iTj(2,1,4) = 0; iTj(2,2,4) = 1;  iTj(2,3,4) = 0; iTj(2,4,4) = 0;
iTj(3,1,4) = 0; iTj(3,2,4) = 0;  iTj(3,3,4) = 1; iTj(3,4,4) = 0.141;
iTj(4,1,4) = 0; iTj(4,2,4) = 0;  iTj(4,3,4) = 0; iTj(4,4,4) = 1;

iTj(1,1,5) = 0; iTj(1,2,5) = 1; iTj(1,3,5) = 0;  iTj(1,4,5) = 0;
iTj(2,1,5) = 1; iTj(2,2,5) = 0; iTj(2,3,5) = 0; iTj(2,4,5) = 0.571;
iTj(3,1,5) = 0; iTj(3,2,5) = 0; iTj(3,3,5) = -1;  iTj(3,4,5) = 0;
...
iTj(3,1,6) = -1; iTj(3,2,6) = 0;  iTj(3,3,6) = 0; iTj(3,4,6) = 0.138;
iTj(4,1,6) = 0; iTj(4,2,6) = 0;  iTj(4,3,6) = 0; iTj(4,4,6) = 1;

iTj(1,1,7) = 0; iTj(1,2,7) = 0;  iTj(1,3,7) = -1; iTj(1,4,7) = 0;
iTj(2,1,7) = 0; iTj(2,2,7) = 1;  iTj(2,3,7) = 0; iTj(2,4,7) = 0;
iTj(3,1,7) = 1; iTj(3,2,7) = 0;  iTj(3,3,7) = 0; iTj(3,4,7) = 0.118;
